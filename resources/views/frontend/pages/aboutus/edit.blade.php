...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-wrapper">
                ...
                <div class="m-portlet__head-tools">
                    <a href="{{ route('about_us') }}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
													<span>
        ...
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{ route('update_about_us',$aboutus_data->id) }}" method="post" enctype="multipart/form-data" id="selectform">
            @csrf
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" name="en_title" id="en_title"  value="{{ $aboutus_data->en_title }}" class="form-control m-input">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" name="ar_title" id="ar_title"  value="{{ $aboutus_data->ar_title }}" class="form-control m-input">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <textarea name="en_description" id="en_description" cols="30" rows="10" class="form-control m-input"  value="">{{ $aboutus_data->en_description }}</textarea>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <textarea name="ar_description" id="ar_description" cols="30" rows="10" class="form-control m-input" value="">{{ $aboutus_data->ar_description }}</textarea>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-md-8">
                            ...
                            <img src="{{ URL::to('/') }}/frontend/website_images/aboutus/{{ $aboutus_data->image }}" class="img-thumbnail" width="100" />
