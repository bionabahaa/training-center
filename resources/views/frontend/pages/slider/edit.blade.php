...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{ route('update_slider',$slider_data->id) }}" method="post" enctype="multipart/form-data" id="selectform">
            @csrf
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" name="en_title" id="en_title"  value="{{ $slider_data->en_title }}" class="form-control m-input">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" name="ar_title" id="ar_title"  value="{{ $slider_data->ar_title }}" class="form-control m-input">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <textarea name="en_description" id="en_description" cols="30" rows="10" class="form-control m-input"  value="">{{ $slider_data->en_description }}</textarea>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <textarea name="ar_description" id="ar_description" cols="30" rows="10" class="form-control m-input" value="">{{ $slider_data->ar_description }}</textarea>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-md-8">
                            ...
                            <img src="{{ URL::to('/') }}/frontend/website_images/slider/{{ $slider_data->image }}" class="img-thumbnail" width="100" />
