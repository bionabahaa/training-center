                                        ...
                                        <div class="m-form__section m-form__section--first">
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-9 col-lg-9">
                                                    <input type="text" name="en_title" class="form-control m-input"  disabled value="{{ $slider_data->en_title }}">
                                                </div>
                                            </div>
                                            <div class="form-group m-form__group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">*@lang('tr.ar_title'):</label>
                                                <div class="col-xl-9 col-lg-9">
                                                    <input type="text" name="ar_title" class="form-control m-input" placeholder="" disabled value="{{ $slider_data->ar_title }}">
                                                </div>
                                            </div>
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-9 col-lg-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="en_description" class="form-control m-input" placeholder="" disabled value="{{ $slider_data->en_description }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-9 col-lg-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"  class="form-control m-input" placeholder=""  disabled value="{{ $slider_data->ar_description }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-9 col-lg-9">
                                                    <div class="input-group">
                                                        ...
                                                        <img src="{{ URL::to('/') }}/frontend/website_images/slider/{{ $slider_data->image }}" class="img-thumbnail" />
                                                    </div>
                                                </div>
                                            </div>
