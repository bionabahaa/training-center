...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-wrapper">
                ...
                <div class="m-portlet__head-tools">
                    <a href="{{ route('gallery') }}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
													<span>
        ...
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{ route('update_gallery',$gallery_data->id) }}" method="post" enctype="multipart/form-data" id="selectform">
            @csrf
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-md-8">
                            ...
                            <img src="{{ URL::to('/') }}/frontend/website_images/gallery/{{ $gallery_data->image }}" class="img-thumbnail" width="100" />
                            <input type="hidden" name="hidden_image" value="{{ $gallery_data->image }}" />
