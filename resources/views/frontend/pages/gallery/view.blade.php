            ...
            <div class="container">
                <div class="heading-page-content">
                    ...
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index2.html">@lang('tr.Home')</a></li>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <article class="item">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('frontend/images/newimages/person_7.jpg')}}" alt="">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <article class="item">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('frontend/images/newimages/person_8.jpg')}}" alt="">
                                    </a>
                                    <div class="our-team-socials position-center">
                                        <ul class="display-flex-center">
                                            <li>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <article class="item">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('frontend/images/newimages/person_9.jpg')}}" alt="">
                                    </a>
                                    <div class="our-team-socials position-center">
                                        <ul class="display-flex-center">
                                            <li>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <article class="item">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('frontend/images/newimages/person_2.jpg')}}" alt="">
                                    </a>
                                    <div class="our-team-socials position-center">
                                        <ul class="display-flex-center">
                                            <li>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <article class="item">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('frontend/images/newimages/person_4.jpg')}}" alt="">
                                    </a>
                                    <div class="our-team-socials position-center">
                                        <ul class="display-flex-center">
                                            <li>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <article class="item">
                                <figure>
                                    <a href="#">
                                        <img src="{{asset('frontend/images/newimages/person_5.jpg')}}" alt="">
                                    </a>
                                    <div class="our-team-socials position-center">
                                        <ul class="display-flex-center">
                                            <li>
            ...
            <div class="container-fluid">
                <div class="gallery-content gallery-hover">
                    <div class="row">
                        <div class="col px-0">
                            <figure>
                                <a href="{{asset('frontend/images/newimages/home1-blog-1.jpg')}}" class="grouped_gallery" data-fancybox="gallery">
                                    <img class="prtofolio_images" src="{{asset('frontend/images/newimages/home1-blog-1.jpg')}}" alt="">
                                </a>
                            </figure>
                        </div>
                        <div class="col px-0">
                            <figure>
                                <a href="{{asset('frontend/images/newimages/home1-blog-2.jpg')}}" class="grouped_gallery" data-fancybox="gallery">
                                    <img class="prtofolio_images" src="{{asset('frontend/images/newimages/home1-blog-2.jpg')}}" alt="">
                                </a>
                            </figure>
                        </div>
                        <div class="col px-0">
                            <figure>
                                <a href="{{asset('frontend/images/newimages/home1-course-1.jpg')}}" class="grouped_gallery" data-fancybox="gallery">
                                    <img class="prtofolio_images" src="{{asset('frontend/images/newimages/home1-course-1.jpg')}}" alt="">
                                </a>
                            </figure>
                        </div>
                        <div class="col px-0">
                            <figure>
                                <a href="{{asset('frontend/images/newimages/home1-course-2.jpg')}}" class="grouped_gallery" data-fancybox="gallery">
                                    <img class="prtofolio_images" src="{{asset('frontend/images/newimages/home1-course-2.jpg')}}" alt="">
                                </a>
                            </figure>
                        </div>
                        <div class="col px-0">
                            <figure>
                                <a href="{{asset('frontend/images/newimages/home1-course-3.jpg')}}images/newimages/home1-course-3.jpg" class="grouped_gallery" data-fancybox="gallery">
                                    <img class="prtofolio_images" src="{{asset('frontend/images/newimages/home1-course-3.jpg')}}" alt="">
                                </a>
                            </figure>
                        </div>
                    </div>
