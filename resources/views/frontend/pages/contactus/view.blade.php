                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12-col-sm-12 col-12 px-0">
                            <div class="contact-form">
                                ...
                                <form method="POST" action="{{ route('store_contact_us') }}" class="form-contact js-contact-form">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="wrap-group">
                                                    <input type="text" en_name="name" placeholder="@lang('tr.Enter English name')*" required>
                                                </div>
                                            </div>
                                    ...
                                    <div class="wrap-group">
                                        <textarea name="ar_message" id="ar_message" cols="10" rows="10"  placeholder="@lang('tr.Enter Arabic message')" required></textarea>
