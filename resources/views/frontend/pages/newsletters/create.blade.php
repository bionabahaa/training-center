...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-wrapper">
                ...
                <div class="m-portlet__head-tools">
                    <a href="{{ route('newsletters') }}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
													<span>
        ...
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{ route('store_newsletters') }}" method="post" enctype="multipart/form-data" id="selectform">
            @csrf
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <label for="email">@lang('tr.en_email'):</label>
