...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{ route('store_faqs') }}" method="post" enctype="multipart/form-data" id="selectform">
            @csrf
