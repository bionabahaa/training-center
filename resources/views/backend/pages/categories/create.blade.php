...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{ route('store_categories') }}" method="post" enctype="multipart/form-data" id="selectform">
            @csrf
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" name="en_name" id="en_name" class="form-control m-input" placeholder="@lang('tr.Enter English name')">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            ...
                            <input type="text" name="ar_name" id="ar_name" class="form-control m-input" placeholder="@lang('tr.Enter Arabic name')">
                        </div>
                    </div>
