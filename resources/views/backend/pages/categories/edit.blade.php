...
@section('content')
    ...
    <div class="m-portlet">
        ...
        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{ route('update_categories',$categories_data->id) }}" method="post" enctype="multipart/form-data" id="selectform">
            @csrf
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" name="en_title" id="en_title"  value="{{ $categories_data->en_title }}" class="form-control m-input">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" name="ar_title" id="ar_title"  value="{{ $categories_data->ar_title }}" class="form-control m-input">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" name="en_name" id="en_name"  value="{{ $categories_data->en_name }}" class="form-control m-input">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" name="ar_name" id="ar_name"  value="{{ $categories_data->ar_name }}" class="form-control m-input">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-md-8">
                            ...
                            <img src="{{ URL::to('/') }}/backend/dashboard_images/categories/{{ $categories_data->image }}" class="img-thumbnail" width="100" />
                            <input type="hidden" name="hidden_image" value="{{ $categories_data->image }}" />
